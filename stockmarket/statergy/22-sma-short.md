...
```bash
//@version=5
strategy("22 SMA Short", overlay=true)
...
shortCondition = close < sma and close[1] < sma[1] and close[2] < sma[2] and high > sma and close < open and sma < sma[1] and sma[1] < sma[2]
